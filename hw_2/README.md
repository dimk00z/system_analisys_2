...
На модели указаны только сервисы со своими доделями, они являются владельцами.
Остальные системы получают от них данные

### PS

По ощущению все плохо=) Давно себя таким потерянным не чувствовал.
